        ...
        $.each(this.options.columns, function (i, column) {
            ...
            if (column.checkbox) {
                if (!that.options.singleSelect && that.options.checkboxHeader) {
                    text = '<input id="bs-table-checkbox-all" name="btSelectAll" type="checkbox" /><label for="bs-table-checkbox-all"></label>';
                }
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = [that.options.cardView ?
                        ...
                        '<input id="bs-table-checkbox-'+ i + '" ' +
                            ...
                            ' /> <label for="bs-table-checkbox-'+i+'"></label>',
